...
export default function Enlacespage() {
    ...
    useEffect(() => {    
      ...
      async function fetchData() {
        try {
          const response = await fetch('http://127.0.0.1:8000/api/enlace');
          if (!response.ok) {
    ...
    return (
        ...
        <div className="bg-slate-400 h-screen">
          ...
          <div>
              ...
              <br />
              <br />
              <h1 className=" font-bold text-3xl text-center pt-10 text-blue-800">Listado de Enlaces</h1>
              <br />
              <div className="bg-[#2F80ED] text-white text-center pt-2 w-[150px] h-[45px] mt-3 mb-8 ml-[80%]">
                <Link to="/enlaces/create" >+Agregar</Link>
              </div>           
              <br />
